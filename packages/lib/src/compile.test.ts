...
describe('compile', () => {
  test('plan 1', () => {
    ...
    const [nodes, edges] = ctx.compile(fromJson(PlanSchema, plan1));
  ...
  test('plan 2', () => {
    const ctx = Compiler.fromCfg(CONFIG);
    const [nodes, edges] = ctx.compile(fromJson(PlanSchema, plan2));
    expect(nodes.length).to.equal(4);
    expect(edges.length).to.equal(3);
  });
});

const plan1: JsonValue = {
        ...
        input: {
          project: {
            ...
            expressions: [
              ...
              {
                selection: {
                  directReference: { structField: { field: 6 } },
                  rootReference: {},
                },
              },
              {
                selection: {
                  directReference: { structField: { field: 7 } },
                  rootReference: {},
                },
              },
              {
                selection: {
                  directReference: { structField: { field: 8 } },
                  rootReference: {},
                },
              },
              {
                selection: {
                  directReference: { structField: { field: 9 } },
                  rootReference: {},
                },
              },
              {
                selection: {
                  directReference: { structField: { field: 10 } },
                  rootReference: {},
                },
              },
              {
                selection: {
                  directReference: { structField: { field: 11 } },
                  rootReference: {},
                },
              },
              {
                selection: {
                  directReference: { structField: { field: 12 } },
                  rootReference: {},
                },
              },
              {
                selection: {
                  directReference: { structField: { field: 13 } },
                  rootReference: {},
                },
              },
              {
                selection: {
                  directReference: { structField: { field: 14 } },
                  rootReference: {},
                },
              },
              {
                selection: {
                  directReference: { structField: { field: 15 } },
                  rootReference: {},
                },
              },
            ],
